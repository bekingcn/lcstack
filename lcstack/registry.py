...
# Graph
from .graph import create_workflow_agent
...
register_component(
    ...
    LcComponent(
        ...
        params={
            "messages_modifier": ComponentParameter(
                type="str"
            ),  # str, SystemMessage, Runnable, Callable(not supported)
...
register_component(
    INITIALIZER_NAME_DOCUMENT_LOADER,
    LcComponent(
...
register_component(
    INITIALIZER_NAME_TYPED_DOCUMENT_LOADER,
    LcComponent(
...
register_component(
    INITIALIZER_NAME_TEXT_SPLITTER,
    LcComponent(
...
register_component(
    INITIALIZER_NAME_INDEXING_PIPELINE,
    LcComponent(
